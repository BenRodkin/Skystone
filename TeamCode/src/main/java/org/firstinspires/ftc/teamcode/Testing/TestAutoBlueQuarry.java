...
public class TestAutoBlueQuarry extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(!isStarted()) {
            ...
            // Set the Countours to the average of the previous 14 and it's value
            ...
            double smallestProportionedTally = largest(contoursProportionLeft,contoursProportionCenter, contoursProportionRight);
