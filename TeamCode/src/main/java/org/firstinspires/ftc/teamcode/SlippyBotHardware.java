...
//    public final double COUNTS_PER_INCH         = (COUNTS_PER_REV_HD_20 * DRIVE_GEAR_REDUCTION) / (WHEEL_DI_INCHES * Math.PI);
    ...
    public static final double CLAMP_LEFT     = 1.0;
    public static final double RELEASE_LEFT   = 0.0;

    private final double CLAMP_RIGHT    = 0.0;
    private final double RELEASE_RIGHT  = 1.0;
    ...
    // Wrist positions
    public static final double WRIST_PLACING  = 0.00;
    public static final double WRIST_GRABBING = 0.82;
    public static final double WRIST_STARTING = 0.35;
    public static final double WRIST_STORING  = 0.10;
